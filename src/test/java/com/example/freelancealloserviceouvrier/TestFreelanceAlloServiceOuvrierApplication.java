package com.example.freelancealloserviceouvrier;
...
public class TestFreelanceAlloServiceOuvrierApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(FreelanceAlloServiceOuvrierApplication::main).with(TestFreelanceAlloServiceOuvrierApplication.class).run(args);
    }
